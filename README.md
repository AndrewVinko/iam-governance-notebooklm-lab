...
<span style="color:red"> um usuário autenticado que não consegue visualizar determinada organização ou recurso dentro de um sistema.</span>
...
⚪ construir ao final um miniguia de estudo reutilizável sobre IAM e Governança de Segurança da Informação.
